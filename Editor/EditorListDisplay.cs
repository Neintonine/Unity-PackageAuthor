...
{
    internal class EditorListDisplay
    {
        ...
        {
            return EditorListDisplay.Display<TSource>(isFoldout, name, EditorStyles.foldoutHeader, list, contentDisplay, add, remove, repaint);
        }
